...
Route::get('/',[HomeController::class,'index'])->middleware(DashboardAuth::class);
Route::get('/about',[AboutController::class,'index'])->middleware(DashboardAuth::class);
Route::get('/pages',[PagesController::class,'index'])->middleware(DashboardAuth::class);
Route::get('/contact',[ContactController::class,'index'])->middleware(DashboardAuth::class);
Route::post('/contact', [ContactController::class, 'submit'])
->name('contact.submit')
->middleware(DashboardAuth::class);


Route::get('/features', [FeaturesController::class, 'index'])->middleware(DashboardAuth::class);
Route::get('/how-to-use', [HowToUseController::class, 'index'])->middleware(DashboardAuth::class);
Route::get('/testimonial', [TestimonialController::class, 'index'])->middleware(DashboardAuth::class);
Route::get('/blog', [BlogController::class, 'index'])->middleware(DashboardAuth::class);
Route::get('/404', [NotFoundController::class, 'index'])->middleware(DashboardAuth::class);


Route::get('/products',[ProductsController::class,'index'])->name('products');
Route::get('/addproducts', [ProductsController::class, 'create'])->name('products.create');
...
Route::prefix('admin')->group(function () {
    ...
    Route::get('/order-item/increase/{id}', [OrderController::class, 'increaseQty'])->name('admin.order.increase');

    Route::get('/order-item/decrease/{id}', [OrderController::class, 'decreaseQty'])->name('admin.order.decrease');

    Route::get('/order-item/delete/{id}', [OrderController::class, 'deleteItem'])->name('admin.order.delete');
...
Route::get('/account/address/edit/{id}',
    [AccountController::class, 'editAddress'])
...
Route::delete('/account/address/delete/{id}',
